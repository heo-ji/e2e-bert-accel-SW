...
#LUT로 인한 variance limit
# variance_limit_min = 33.5 #for test
variance_limit_max = 31.6 ###################################inverse square root 값이 0000이 안나오는 값
...
'''
inverse square root (분산) => lut사용

input = 
acc       (total = 26 , scale_factor = 8)
acc2      (total = 34 , scale_factor = 8)
mean      (total = 16 , scale_factor = 8)
mean2     (total = 32 , scale_factor = 8)
var       (total = 24 , scale_factor = 16)
invsqrt   (total = 16 , scale_factor = 8)



acc(18.8) = 3FFCF4E
acc2(26.8) = 000004EC45
mean(8.8) = FFEF
...
class signed_CustomInvSqr:
    ...
    def forward(self, x_hex):
        ...
        # Convert the result back to unsigned for the final output = python 숫자 -> bit pattern으로
