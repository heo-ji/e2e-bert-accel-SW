...
file = [
    "10_FFNout(original)",
    "10_FFN_ADDout(original)"]


hist_ranges = [(-10, 10), (-5, 5)]
...
# 전체 그림을 파일로 저장
plt.savefig("./(ori)10_FFNout and FFN residualconnection.png")
...
# 전체 그림 저장
plt.savefig("./(ori)10_FFNout and FFN residualconnection_topk.png")
