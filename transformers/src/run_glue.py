...
##cd usr/local/lib/python3.10/dist-packages/transformers/models/bert/modeling_bert.py
# git clone https://github.com/huggingface/transformers.git
# cd transformers
# pip install -e . // transformer 내부 modeling bert로 들어감!!!!!!!!
...
class ModelArguments:
    ...
    softmax_method: Optional[str] = field(
        default="original", metadata={"help": "Softmax method to use: 'cordic', 'log2e', or 'original'"}
    )
    ###추가함
    hidden_act: Optional[str] = field(
        default="gelu", metadata={"help": " gelu method to use: 'gelu' or 'CustomGELU'"}
    )
